...
class AstarPathPlanner(Node):
    def __init__(self):
        ...
        self.costs = self.load_uneven_astar_config()
    ...
    def load_uneven_astar_config(self):
        ...
        while open_set:
            ...
            for neighbor in neighbors:
                ...
                if needs_rotation:
                    ...
                    if cross_product > 0:
                        rotation_cost = rotate_left_cost
                    else:
                        rotation_cost = rotate_right_cost
                    tentative_g_score = g_score[current] + straight_cost + rotation_cost
                    # tentative_g_score = g_score[current] + straight_cost * dis_per_grid + rotation_cost
                else:
                    tentative_g_score = g_score[current] + straight_cost 
                    # tentative_g_score = g_score[current] + straight_cost * dis_per_grid
    ...
    def log_path_planning(self, tb_id, planning_time, path_length, start_pos, goal_pos, success=True):
        ...
        with open(log_file, "a") as f:
            ...
            if success:
                ...
                f.write(f"Costs - Straight: {self.costs['straight']}, "
